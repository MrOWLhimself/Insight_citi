...
async function getAnalyticsClient() {
  ...
  if (!supabaseUrl || !supabaseAnonKey) {
    console.warn('Supabase env missing. Insight analytics skipped.')
    return null
  }
...
export async function trackPageview(page, pageTitle) {
  try {
    ...
    console.warn('Insight analytics pageview failed:', error)
  }
}
...
export async function trackEvent(eventName, eventValue) {
  try {
    ...
    console.warn('Insight analytics event failed:', error)
  }
}
